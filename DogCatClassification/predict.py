...
from model import GoogLeNet, Inception   # 或 ResNet18 等
...
# 3. 模型加载
# -----------------------------
model = GoogLeNet(Inception, in_channels=3, num_classes=2)
model.load_state_dict(torch.load("./DeepNet/best_model.pth", map_location=device))
model.to(device)
model.eval()
