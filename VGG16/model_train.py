...
def train_val_data_process():
    ...
    val_loader = Data.DataLoader(
        val_data, batch_size=10, shuffle=False, num_workers=2
    )
...
def train_model(
    ...
    val_loader,
    num_epochs=20,
    checkpoint_path='./VGG16/checkpoint.pth'
):
    ...
    torch.save(best_model_weights,"VGG16/best_model.pth")
...
def plot_acc_loss(df):
    ...
    plt.savefig('./VGG16/acc_loss.png')
...
if __name__ == '__main__':
    ...
    df = train_model(model, train_loader, val_loader, num_epochs=20)
    plot_acc_loss(df)
